...
export default async function RootLayout({
  ...
  const siteUrl = "https://nozim-j.uz";
  ...
  > = {
    ru: {
      title: "Нозим  Жумаев",
      description:
        "Опытный бариатрический хирург с многолетней практикой. Специализируется на передовых методах хирургического лечения ожирения и смежных проблем",
    ...
    uz: {
      title: "Nozim Jumayev",
      description:
        "Tajribali bariatrik jarroh ko‘p yillik amaliyotga ega. Semizlik va unga bog‘liq muammolarni jarrohlik yo‘li bilan davolashning ilg‘or usullariga ixtisoslashgan",
      imageUrl: `${siteUrl}/favicon.ico`,
  ...
  return (
    <html lang={locale}>
      <head>
        ...
        <meta name="author" content="Result Agency" />
        ...
        <meta property="og:site_name" content="Nozim J" />
        {/* Теги для Twitter */}
